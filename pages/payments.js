...
import PaymentsProvidersGrid from "@/components/grids/PaymentsProvidersGrid";

export default function payments() {
  return (
    <>
      <PaymentsTab Payments={<Payments />} PaymentMethods={<PaymentMethods />}  PaymentsProviders={<PaymentsProviders />}/>
    </>
  );
}
    ...
    <>
      <>
        <Grid container spacing={1}>
          ...
          <Grid item xs={12} md={9}>
            <PaymentsProvidersGrid filterDates={filterDates} status={status} />
          </Grid>
        </Grid>
      </>
    </>
