...
export default function useDte() {
  ...
  const facturaProcess = async (saleInfo) => {
    const customer = await customers.findOneById(saleInfo.customerId);
    console.log("SaleInfo-Customer", saleInfo, customer);
    const data = {
      emisor: {
        tipodoc: "33",
      ...
      receptor: {
        rut: customer.rut.replace(/\./g, ""),
        rs: customer.name,
        giro: customer.activity.substring(0, 39),
        comuna: customer.district,
    ...
    const factura = await lioren.factura(data);
    console.log("Factura", factura);
    const xml = processXlm(factura.xml);
    ...
    dteData.documentType = 3;
    dteData.total = saleInfo.total;
    dteData.subTotal = saleInfo.subTotal;
    dteData.subjectTotal = subjectTotal(saleInfo.items);
    dteData.exemptTotal = factura.montoexento;
    dteData.discounts = saleInfo.discounts;
    dteData.iva =factura.montoiva;
    dteData.change = saleInfo.change;
    dteData.items = saleInfo.items;
    dteData.payments = saleInfo.pays;
    dteData.saleId = saleInfo.id;
    dteData.stamp = xml;
    dteData.referenceId = factura.folio;
    dteData.customer = customer
  ...
  const ticketProcess = (saleInfo) => {
    ...
    data.stamp =
      "<SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7>" +
      saleInfo.id +
      "<SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7><SAMI7>";
  ...
  const processXlm = (data) => {
    ...
    let timbre_str =
      ...
      "</FA>" +
      "<RSAPK><M>" +
      CAF.DA[0].RSAPK[0].M[0] +
      "</M>" +
      "<E>" +
      CAF.DA[0].RSAPK[0].E[0] +
      "</E></RSAPK>" +
      "<IDK>" +
      CAF.DA[0].IDK[0] +
      "</IDK></DA>" +
